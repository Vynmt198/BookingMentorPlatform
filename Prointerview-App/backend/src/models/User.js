...
export function toPublicUser(doc) {
  ...
  const out = {
    ...
    quota: plain.quota ? {
      cvAnalysisUsed: plain.quota.cvAnalysisUsed ?? 0,
      cvAnalysisLimit: plain.quota.cvAnalysisLimit ?? 0,
      mentorSessionUsed: plain.quota.mentorSessionUsed ?? 0,
      mentorSessionLimit: plain.quota.mentorSessionLimit ?? 0,
    } : {
      cvAnalysisUsed: 0,
      cvAnalysisLimit: 2,
      mentorSessionUsed: 0,
