...
async function main() {
  ...
  mentors.primary = await upsertDoc(
    ...
    { userId: users.mentorDev._id },
    {
      ...
      finance: {
        ...
        totalEarned: 2590000,
        bankAccounts: [
          { bankName: "Vietcombank", accountNumber: "001122334455", accountName: "Mentor Dev", isDefault: true },
        ],
  ...
  mentors.secondary = await upsertDoc(
    ...
    { userId: users.mentorCareer._id },
    {
      ...
      finance: {
        ...
        totalEarned: 1210000,
        bankAccounts: [
          { bankName: "ACB", accountNumber: "556677889900", accountName: "Mentor Career", isDefault: true },
        ],
  ...
  for (const [key, profileViews] of [["primary", 126], ["secondary", 74]]) {
    ...
    mentor.finance = {
      ...
      bankAccounts: financeBase.bankAccounts || [],
